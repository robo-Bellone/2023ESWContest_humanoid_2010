...
전진작은걸음_골프_2:
    ...
    ' 보행COUNT = 보행COUNT + 1
    'IF 보행COUNT > 보행횟수 THEN  GOTO 전진작은걸음_골프_2_stop
...
전진작은걸음_골프_5:
    ...
    ' 보행COUNT = 보행COUNT + 1
    ' IF 보행COUNT > 보행횟수 THEN  GOTO 전진작은걸음_골프_5_stop
...
후진작은걸음_골프_3:
    ...
    ENDIF
    ' 보행COUNT = 보행COUNT + 1
    ' IF 보행COUNT > 보행횟수 THEN  GOTO 후진작은걸음_골프_3_stop
...
후진작은걸음_골프_6:
    ...
    ' 보행COUNT = 보행COUNT + 1
    'IF 보행COUNT > 보행횟수 THEN  GOTO 후진작은걸음_골프_6_stop
...
승부차기왼쪽작:
    ...
    '*************
    MOVE G6A,90,  78, 155,  98, 100, 100
    MOVE G6D,90,  66, 140,  88, 100, 100
    WAIT
...
승부차기오른쪽작:
    ...
    '*************
    MOVE G6D,90,  78, 155,  98, 100, 100
    MOVE G6A,90,  66, 140,  88, 100, 100
    WAIT
...
오른쪽옆으로20_골프: '****
    ...
    SPEED 12
    MOVE G6D, 95,  90, 125, 100, 102, 100
    MOVE G6A,107,  77, 147,  93, 102 , 100
    WAIT
...
왼쪽옆으로20_골프: '****
    ...
    SPEED 12
    MOVE G6A, 95,  90, 125, 100, 102, 100
    MOVE G6D,105,  76, 146,  93, 102, 100
    WAIT

    SPEED 12
    MOVE G6A, 102,  76, 146, 93, 100, 100
    MOVE G6D,90,  80, 140,  95, 105, 100
    WAIT
